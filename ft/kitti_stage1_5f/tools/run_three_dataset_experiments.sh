...
INIT_FROM="${INIT_FROM:-}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/output/three_dataset_experiments}"
...
run_exp "01_unified_kitti_only" "${MULTI_DATASET_ARGS[@]}" --dataset_ratio "1:0"
run_exp "02_unified_nuscenes_only" "${MULTI_DATASET_ARGS[@]}" --dataset_ratio "0:1"
run_exp "03_unified_kitti_nuscenes_all_frames" "${MULTI_DATASET_ARGS[@]}" --dataset_ratio "${MIXED_DATASET_RATIO}"
