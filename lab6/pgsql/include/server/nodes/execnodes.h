 ...
 *		OuterBlockSlots	   copied outer tuple block for block nested loop join
 * ----------------
 */
typedef struct NestLoopState
{
	...
	int			nl_BlockCount;
	int			nl_BlockIndex;
	bool		nl_OuterExhausted;
	bool		nl_HaveInnerTuple;
	TupleTableSlot *nl_CurrentInnerTupleSlot;
	TupleTableSlot **nl_OuterBlockSlots;
} NestLoopState;
