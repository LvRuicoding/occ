...
static struct config_int ConfigureNamesInt[] =
{
	...
	{
		{"block_nested_loop_size", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Sets the number of outer tuples used by block nested-loop join."),
			gettext_noop("A value of 1 preserves ordinary nested-loop behavior."),
			GUC_EXPLAIN
		},
